...
<div class="row">
	<div class="col-md-12">
		<div class="x_panel">
			...
			<div class="x_content">
				<form method="post"
					action="${pageContext.request.contextPath }/developer/appinfo/list">
				...
				<div id="datatable-responsive_wrapper"
					...
					<div class="row">
						<div class="col-sm-12">
							...
							<a href="${pageContext.request.contextPath}/addView"
							...
							<table id="datatable-responsive"
								...
								<thead>
									<tr role="row">
										<th class="sorting_asc" tabindex="0"
											...
											aria-sort="ascending" style="font-size: 15px">软件名称</th>
										<th class="sorting" tabindex="0"
											aria-controls="datatable-responsive" rowspan="1" colspan="1"
											aria-label="Last name: activate to sort column ascending" style="font-size: 15px">
											APK名称</th>
										<th class="sorting" tabindex="0"
											aria-controls="datatable-responsive" rowspan="1" colspan="1"
											aria-label="Last name: activate to sort column ascending" style="font-size: 15px">
								...
								<tbody style="font-size: 14px">
									<c:forEach var="appInfo" items="${appInfoList.list }"
										varStatus="status">
										<tr role="row" class="odd">
											<td tabindex="0" class="sorting_1">${appInfo.softwareName}</td>
											<td>${appInfo.APKName }</td>
											<td>${appInfo.softwareSize }</td>
											<td>${appInfo.dataDictionary2.valueName }</td>
											<td>${appInfo.appCategory1.categoryName } ->
												${appInfo.appCategory2.categoryName } ->
												${appInfo.appCategory3.categoryName }</td>
											<td><span id="appInfoStatus${appInfo.id}">${appInfo.dataDictionary1.valueName
													}</span></td>
											...
											<td>
												...
												<div class="btn-group">
													...
													<ul class="dropdown-menu" role="menu">
														...
														<li><a class="modifyVersion" id="modifyVersion${appInfo.id}"
															appinfoid="${appInfo.id }"
															versionid="${appInfo.versionId }"
															status="${appInfo.status }"
															statusname="${appInfo.dataDictionary2.valueName }" data-toggle="tooltip"
															data-placement="top" title=""
															data-original-title="修改APP最新版本信息">修改版本</a></li>
														<li><a class="modifyAppInfo"
															appinfoid="${appInfo.id }" id="modifyAppInfo${appInfo.id}" status="${appInfo.status }"
															statusname="${appInfo.dataDictionary2.valueName }" data-toggle="tooltip"
															data-placement="top" title=""
					...
					<div class="row">
						<div class="col-sm-5">
                            ...
                            <ul class="pagination" id="abc" style="float: right;margin-right: 60px">

                                <c:if test="${!appInfoList.isFirstPage}">
                                    <li style="display: inline-block;margin-right: 5px">
                                        <a href="${pageContext.request.contextPath }/developer/appinfo/list?pageIndex=1">首页</a>
                                    </li>
                                    <li style="display: inline-block;margin-right: 5px">
                                        <a href="${pageContext.request.contextPath }/developer/appinfo/list?pageIndex=${appInfoList.pageNum - 1}">上一页</a>
                                    </li>
                                </c:if>
                                
                                <c:if test="${!appInfoList.isLastPage}">
                                    <li style="display: inline-block;margin-right: 5px">
                                        <a href="${pageContext.request.contextPath }/developer/appinfo/list?pageIndex=${appInfoList.pageNum + 1}">下一页</a>
                                    </li>

                                    <li style="display: inline-block">
                                        <a href="${pageContext.request.contextPath }/developer/appinfo/list?pageIndex=${appInfoList.pages}">尾页</a>
                                    </li>
                                </c:if>
